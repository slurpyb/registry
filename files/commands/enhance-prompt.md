---
description: Rewrites and enhances a user-provided prompt to be clearer, more specific, less ambiguous, and structured with XML semantic tags, contextual information, explicit instructions, sequential steps, and success criteria.
agent: plan
